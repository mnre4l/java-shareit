...
public class UserController {
    ...
    public ResponseEntity<Object> updateUser(@RequestBody @Valid UserDto userDtoUpdated, @PathVariable("userId") long userId) {
        log.info("PATCH /users/userId: получен для id = {}", userId);
        return userClient.updateUser(userId, userDtoUpdated);
    }
